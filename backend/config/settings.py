...
# Explicit environment variables (shell exports, Docker env_file) still take effect.
...
# Cloud-tagged Ollama models would send prompts off this machine.
...
# Minimum cosine similarity a vector hit must reach to be returned. Cosine
# scores are not calibrated across embedding models or corpora, so the default
# of 0.0 keeps every hit. See docs/evaluation.md for the measured separation on
# the shipped corpus and why no cutoff is hardcoded.
VECTOR_MIN_SCORE = env("VECTOR_MIN_SCORE")

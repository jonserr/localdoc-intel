...
from evaluations.harness import EvaluationMetrics
...
def fake_metrics(question_count: int = 1) -> EvaluationMetrics:
    ...
    return EvaluationMetrics(
        ...
        retrieval_strategy_counts={"bm25": question_count},
        labeled_question_count=question_count,

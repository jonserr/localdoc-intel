...
class DocumentSerializer(serializers.ModelSerializer):
    ...
    # ``status`` describes text ingestion (chunks stored and keyword-searchable);
    # ``vector_indexing`` describes the separate vector index lifecycle.
    vector_indexing = serializers.SerializerMethodField()
    ...
    def get_vector_indexing(self, obj: Document) -> str:
        return (obj.metadata or {}).get("vector_indexing") or "not_requested"
